  ...
  return (
    ...
    {isAiThumbnail ? (
      <div className='flex flex-col gap-5'>
        ...
        <Textarea 
          className='input-class font-light focus-visible:ring-offset-lime-500' 
      ...
      <Button 
      type="submit" 
      className="text-16 bg-lime-500 py-4 font-bold text-white-1"
      ...
      <div className="image_div" onClick={() => imageRef?.current?.click()}>
        <Input 
          ...
          <div className='flex flex-col items-center gap-1'>
            <h2 className='text-12 font-bold text-lime-500'>
