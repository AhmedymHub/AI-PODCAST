...
export const podcastData = [
  {
    ...
    imgURL:
      "https://tapesearch.com/cdn-cgi/image/width=600,format=avif/https://megaphone.imgix.net/podcasts/8e5bcebc-ca16-11ee-89f0-0fa0b9bdfc7c/image/c2c595e6e3c2a64e6ea18fb6c6da8860.jpg?ixlib=rails-4.3.1&max-w=3000&max-h=3000&fit=crop&auto=format,compress",
  },
  {
    id: 2,
    title: "The Futur",
  ...
  },
  {
    ...
    description: "A long form, in-depth conversation",
    imgURL:
      "https://is1-ssl.mzstatic.com/image/thumb/Podcasts221/v4/31/19/50/311950b1-cc64-d795-1cb4-03d76f108f3a/mza_10891338178354210660.jpg/1200x1200bf-60.jpg",
  },
  {
    id: 6,
    title: "Syntax ",
